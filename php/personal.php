<?php
// admin/personal.php — gestión básica de usuarios (admins/docentes para login)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($accion === 'crear') {
            ...
            $tipo    = ($_POST['tipo_usuario'] ?? 'admin') === 'docente' ? 'docente' : 'admin';
...
<head>
  <meta charset="UTF-8">
  <title>Personal — DocenteTrack</title>
