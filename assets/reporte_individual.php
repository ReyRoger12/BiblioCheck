...
// 1. Obtener datos del docente (usamos 'cedula_profesional' como No. de Control y 'puesto' como Carrera)
$stmt_doc = $conexion->prepare("SELECT nombre, id_docente, puesto, cedula_profesional FROM docentes WHERE id = ?");
