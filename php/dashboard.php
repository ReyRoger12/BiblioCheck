...
<head>
  <meta charset="UTF-8">
  <title>Dashboard - DocenteTrack</title>
...
<body>
  <aside class="sidebar">
    ...
    <div class="usuario-en-sesion">
      <img src="https://localhost/DOCENTETRACK/assets/user.png" alt="Avatar" class="avatar">
    ...
    <ul>
      <li class="activo"><a href="#"><i class="fa-solid fa-table-columns"></i> Inicio</a></li>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td class="acciones"><a class="btn-editar" href="https://localhost/DocenteTrack/php/docentes.php"><i class="fa-solid fa-pen"></i></a></td>
            </tr>
            <tr>
              <td>Puestos</td>
              <td>Gestión de puestos y asignaciones.</td>
              <td class="acciones"><a class="btn-editar" href="https://localhost/DocenteTrack/php/cursos.php"><i class="fa-solid fa-pen"></i></a></td>
            </tr>
            <tr>
              <td>Asistencias</td>
              <td>Consulta y reportes de asistencia por día.</td>
              <td class="acciones"><a class="btn-editar" href="https://localhost/DocenteTrack/php/asistencia.php"><i class="fa-solid fa-pen"></i></a></td>
            </tr>
            <tr>
              <td>Reportes</td>
              <td>Filtros por fecha y exportación CSV.</td>
              <td class="acciones"><a class="btn-editar" href="https://localhost/DocenteTrack/php/reportes.php"><i class="fa-solid fa-pen"></i></a></td>
            </tr>
          </tbody>
        </table>
      </div>
