...
session_start();
if (empty($_SESSION['user'])) { header('Location: ../html/login-admin.html'); exit; }
require_once __DIR__ . '/../php/conexion.php';

const UPLOAD_DIR_PERMISOS = __DIR__ . '/../uploads/permisos';
const UPLOAD_WEB_PERMISOS = '/uploads/permisos';
...
$alumnos = $conexion->query("SELECT id, nombre FROM alumnos WHERE status='Activo' ORDER BY nombre")->fetch_all(MYSQLI_ASSOC);

// Obtener lista de permisos
$sql_list = "SELECT p.*, a.nombre as alumno_nombre 
             FROM permisos p 
...
<body>
  <aside class="sidebar">
    ...
    <ul>
      ...
      <li><a href="alumnos.php">Personal</a></li>
      ...
      <li class="activo"><a href="permisos.php"><i class="fa-solid fa-notes-medical"></i> Permisos</a></li>
